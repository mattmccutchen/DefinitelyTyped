import ILengthAble = _MeteorGlobals.ILengthAble;
import ITinytestAssertions = _MeteorGlobals.ITinytestAssertions;
import Tinytest = _MeteorGlobals.Tinytest;

declare module "meteor/tiny-test" {
    import * as _MeteorTinyTest from "meteor/tiny-test";
    global {
        namespace _MeteorGlobals {
            export import ILengthAble = _MeteorTinyTest.ILengthAble;
            export import ITinytestAssertions = _MeteorTinyTest.ITinytestAssertions;
            export import Tinytest = _MeteorTinyTest.Tinytest;
        }
    }

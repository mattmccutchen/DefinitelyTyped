import Meteor = _MeteorGlobals.Meteor;
import Subscription = _MeteorGlobals.Subscription;

declare module "meteor/meteor" {
    import * as _MeteorMeteor from "meteor/meteor";
    global {
        namespace _MeteorGlobals {
            export import Meteor = _MeteorMeteor.Meteor;
        }
    }
...
declare module "meteor/meteor" {
    ...
    global {
        namespace _MeteorGlobals {
            export import Subscription = _MeteorMeteor.Subscription;
        }
    }

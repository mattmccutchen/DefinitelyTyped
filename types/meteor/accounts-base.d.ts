import URLS = _MeteorGlobals.URLS;
import EmailFields = _MeteorGlobals.EmailFields;
import Accounts = _MeteorGlobals.Accounts;
import Header = _MeteorGlobals.Header;
import EmailTemplates = _MeteorGlobals.EmailTemplates;

declare module "meteor/accounts-base" {
    import * as _MeteorAccountsBase from "meteor/accounts-base";
    global {
        namespace _MeteorGlobals {
            export import URLS = _MeteorAccountsBase.URLS;
            export import Accounts = _MeteorAccountsBase.Accounts;
        }
    }
...
declare module "meteor/accounts-base" {
    ...
    global {
        namespace _MeteorGlobals {
            export import EmailFields = _MeteorAccountsBase.EmailFields;
            export import Header = _MeteorAccountsBase.Header;
            export import EmailTemplates = _MeteorAccountsBase.EmailTemplates;
        }
    }
